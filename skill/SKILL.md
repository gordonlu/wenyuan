...
Use this skill when the user needs structured deliberation for a complex decision. Output language should match the user's input language.
...
Target length: 500-900 Chinese characters.
...
Target length: 1000-1800 Chinese characters.
